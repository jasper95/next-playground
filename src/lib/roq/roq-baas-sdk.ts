...
interface OrganizationSDK {
  ...
  findMany: <T extends Prisma.organizationFindManyArgs, R extends GetFindResult<Prisma.$organizationPayload<DefaultArgs>, T>[]>(
  ...
  findFirst: <T extends Prisma.organizationFindFirstArgs, R extends GetFindResult<Prisma.$organizationPayload<DefaultArgs>, T>>(
...
export class RoqBaasSdk {
  ...
  private initSDK() {
    ...
    this.organization = {
      ...
      upsert: async function upsertOrganization<T extends Prisma.organizationUpsertArgs, R extends Prisma.organizationGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.organizationUpsertArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
      ...
      delete: async function deleteOrganization<T extends Prisma.organizationDeleteArgs, R extends Prisma.organizationGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.organizationDeleteArgs>,
        options?: RequestOptions,
      ) {
